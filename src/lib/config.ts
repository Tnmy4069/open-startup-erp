export const AppConfig = {
  ...
  iconUrl: process.env.NEXT_PUBLIC_APP_ICON_URL || process.env.NEXT_PUBLIC_FAVICON_URL || process.env.NEXT_PUBLIC_APP_LOGO_URL || '/cyberx-logo.webp',
  faviconUrl: process.env.NEXT_PUBLIC_FAVICON_URL || process.env.NEXT_PUBLIC_APP_ICON_URL || process.env.NEXT_PUBLIC_APP_LOGO_URL || '/cyberx-logo.webp',
